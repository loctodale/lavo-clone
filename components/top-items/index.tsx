...
const TopItems = () => {
    return (
        <div className="mt-[4rem]">
            ...
            <div className="flex flex-col md:flex-row gap-4 py-[4rem] px-4">
                <div className="bg-[url(/19-web-3000.jpg)] bg-no-repeat bg-cover  w-full md:w-1/2 h-[25vh] md:h-[50vh]"></div>
                <div className="bg-[url(/19-web-3000.jpg)] bg-no-repeat bg-cover  w-full md:w-1/2 h-[25vh] md:h-[50vh]"></div>
            </div>
        </div>
