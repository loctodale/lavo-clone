    ...
    <div className="flex flex-col lg:flex-row gap-8 lg:gap-4 justify-between">
      ...
      <div className="flex flex-col gap-2 w-full lg:w-1/4">
        ...
        <div className="space-y-2">
          <div className="flex">
            <span className="w-24 font-bold">Địa chỉ:</span>
            <span className="font-normal">
      34 ĐÀO DUY ANH, PHƯỜNG 9, <br />
      QUẬN PHÚ NHUẬN, TPHCM
    </span>
          </div>
          <div className="flex">
            <span className="w-24 font-bold">Điện thoại:</span>
            <span className="font-normal">(02)838424372</span>
          </div>
          <div className="flex">
            <span className="w-24 font-bold">HOTLINE:</span>
            <span className="font-normal">0919797414</span>
          </div>
          <div className="flex">
            <span className="w-24 font-bold">Fax:</span>
      ...
      <div className="w-full lg:w-1/4">
        ...
        <div className="flex gap-2 py-6">
          ...
          {/*<Youtube size={40} />*/}
            ...
            <div>
                <Image width={40} height={40} src="https://img.icons8.com/?size=100&id=32292&format=png&color=ffffff" alt="instagram-icon" />
            </div>
            <div>
                <Image width={40} height={40} src="https://img.icons8.com/?size=100&id=85064&format=png&color=ffffff" alt="youtube-icon" />
            </div>
          <div>
