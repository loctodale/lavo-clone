...
const Footer = () => {
    return (
        <div className={"py-[4rem] bg-black text-white text-[1rem]"}>
            <div className={"px-[1rem] mx-[16rem]"}>
                <div className={"flex gap-4 justify-between"}>
                    <div className={"location flex flex-col gap-2 w-1/4"}>
                        <Image className={"mb-4"} width={150} height={150} src={"/branding-logo.png"} alt={"logo"} />
                        <h3 className={"font-bold"}>Địa chỉ: <span className={"font-[400]"}>11 Nguyễn Sơn, P. Phú Thạnh, <br/> Q. Tân Phú, TP.HCM</span></h3>
                        <h3 className={"font-bold"}>Điện thoại: <span className={"font-[400]"}>028 3973 5599 – 028 3973 6699</span></h3>
                        <h3 className={"font-bold"}>HOTLINE: <span className={"font-[400]"}>1900 77 99 26</span></h3>
                        <h3 className={"font-bold"}>Fax: <span className={"font-[400]"}>028 3973 5959</span></h3>
                        <h3 className={"font-bold"}>Email: <span className={"font-[400]"}>lavo@lavo.com.vn</span></h3>
                    </div>
                    <div className={"register-noti w-1/4 mt-8"}>
                    ...
                    <div className={"social w-1/4"}>
                        <h3 className={"uppercase font-bold text-[#fdc254] mt-8"}>
                            Mạng xã hội
                        </h3>
                    ...
                    <div className={"links w-1/4"}>
                        <h3 className={"uppercase font-bold text-[#fdc254] mt-8 mb-4"}>
                            Liên kết
                        </h3>
